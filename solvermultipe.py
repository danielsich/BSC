...
#append results
def append_results_to_csv(customers, averagespeed, distance, vehicles, costs, tts,weighted_load, positive_height_diff,total_fuel, driver_pay, filepath='output/outpeserver.csv'):
