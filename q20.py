...
#append results
def append_results_to_csv(customers, averagespeed, distance, vehicles, costs, tts, weighted_load, positive_height_diff,total_fuel, driver_pay,eff,a,xxx, filepath='qi/qi20.csv'):
...
def append_nan_results_to_csv(customers,eff,a,xxx, filepath='qi/qi20.csv'):
    with open(filepath, 'a', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
...
while xxx < 11:    #set parameters
    ...
    diff = bi - ai - (7200)  # difference minus timewindows
