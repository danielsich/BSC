...
filtered_df['fuel_per_100000_distance'] = (filtered_df['total_fuel'] / filtered_df['distance']) * 100000
...
filtered_df['drivercost_per_100000_distance'] = (filtered_df['driver_pay'] / filtered_df['distance']) * 100000
